...
const profile = {
  ...
  certifications: "AutoCAD Electrical Essentials Course — SourceCAD; Introduction to IoT and Digital Transformation — Cisco & NASSCOM; Python Foundation Certification — Infosys Springboard; Exploring SAP S/4HANA Sales Essentials — SAP Learning Hub; and Introducing Joule Studio in SAP Build — SAP Learning Hub.",
  ...
  interests: "Power System Distribution, Renewable Energy Generation, Protection & Control, and Substation Automation.",
...
function answerQuestion(question) {
  ...
  if (/interest|power system|renewable|substation|protection/.test(q)) return `Interests: ${profile.interests}`;
